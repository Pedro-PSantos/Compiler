...
public class ExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TYPE", "STRING", "VARIABLE", "INT", "FLOAT", "MINUS", "PLUS", "DIVISION", 
			"MULTIPLICATION", "INTDIVISION", "EXPONENTIAL", "MODULE", "CONDITIONALS", 
			"SMALLER", "SMALLEREQ", "BIGGER", "BIGGEREQ", "DIFFERENT", "EQUALS", 
			"IF", "ELIF", "ELSE", "DEF", "WHILE", "FOR", "RETURN", "COMMENT", "WS", 
